...
public final class Objects {
     ...
     * <p>
     * This method is useful for implementing {@link Object#hashCode()} on objects containing
     * multiple fields. For example, if an object that has three fields, {@code x}, {@code y}, and
     * {@code z}, one could write: <blockquote>
     * 
     * <pre>
     * &#064;Override
     * public int hashCode() {
     ...
     * </pre>
     * 
     * </blockquote> <b>Warning: When a single object reference is supplied, the returned value does
     * not equal the hash code of that object reference.</b> This value can be computed by calling
     ...
     * <p>
     * Note that if one of the arguments is {@code null}, a {@code NullPointerException} may or may
    ...
    /**
     * Returns {@code true} if the provided reference is {@code null} otherwise returns
     * {@code false}.
     * 
    ...
    /**
     * Returns {@code true} if the provided reference is non-{@code null} otherwise returns
     * {@code false}.
     * 
     * @apiNote This method exists to be used as a {@link java.util.function.Predicate},
